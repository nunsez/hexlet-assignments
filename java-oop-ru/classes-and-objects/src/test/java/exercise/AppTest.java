...
class AppTest {
    ...
    void testSegment() throws Exception {
        ...
        assertThat(segment.beginPoint()).isEqualTo(point1);
        assertThat(segment.endPoint()).isEqualTo(point2);
    }
    ...
    void testGetMidPoint() throws Exception {
        ...
        assertThat(midPoint.x()).isEqualTo(-1);
        assertThat(midPoint.y()).isEqualTo(1);
    }
